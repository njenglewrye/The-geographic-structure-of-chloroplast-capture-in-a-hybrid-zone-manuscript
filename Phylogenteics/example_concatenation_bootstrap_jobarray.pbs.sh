...
raxml-ng -bootstrap --model partition.90missing.txt --msa concatenated.90missing.50taxadeleted.nickdissertation.fasta --prefix bootstrap_${SGE_TASK_ID} --seed $RANDOM --bs-trees 1 --threads 36
