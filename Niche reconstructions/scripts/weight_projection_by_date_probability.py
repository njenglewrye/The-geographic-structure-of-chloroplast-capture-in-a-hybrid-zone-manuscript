...
for date in dates:
	for taxon in taxa:
		...
		cmd = 'gdal_calc.py -A projected/{0}.Bio17_{1}.tifout_table_BIOCLIM_17.tif --outfile=projected_weighted/{0}.bio17_{1}.tif --calc="A*{2}"'.format(taxon, date, df["t_n{0}".format(taxon)][date])
		print(cmd)
